...
match clasificacion:
    case "niño":
        print("Es importante comer bien cuando eres niño")
    case "adolescente":
        print("Es importante estar concetrado cuando eres adolescente")
    case "adulto":
        print("Es importante ser comunicativo cuando eres adulto")
    case "adulto mayor":
        print("Es importante ser paciente cuando eres un adulto mayor")
    case _:
        pass
